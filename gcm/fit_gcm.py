...
def build_count_matrix(frag_lists, vocab):
...
def main():
    ...
    X_train = build_count_matrix(train_frags, vocab)
    X_val = build_count_matrix(val_frags, vocab)
    X_test = build_count_matrix(test_frags, vocab)
